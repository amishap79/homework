...
Sub summarizeStocks()
    ...
    Worksheets("A").Range("P1").Value = "Ticker"
    Worksheets("A").Range("Q1").Value = "Value"
    
    ' set rows of summary data
    Worksheets("A").Range("O2").Value = "Greatest % Increase"
    Worksheets("A").Range("P2").Value = greatestPercentIncreaseTicker
    Worksheets("A").Range("Q2").Value = greatestPercentIncrease
    
    Worksheets("A").Range("O3").Value = "Greatest % Decrease"
    Worksheets("A").Range("P3").Value = greatestPercentDecreaseTicker
    Worksheets("A").Range("Q3").Value = greatestPercentDecrease
    
    Worksheets("A").Range("O4").Value = "Greatest Total Volume"
    Worksheets("A").Range("P4").Value = greatestTotalVolumeTicker
    Worksheets("A").Range("Q4").Value = greatestTotalVolume
